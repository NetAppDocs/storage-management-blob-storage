...
. https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-connector-azure.html[Install a Console agent^] in the Azure account where you want to view your Azure Blob storage accounts.
